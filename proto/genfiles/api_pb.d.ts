...
export namespace Logs {
    ...
    interface ISaveSensorDataRequest {
        ...
        logs?: (Logs.ILogs|null);
    }

    /** Represents a SaveSensorDataRequest. */
    class SaveSensorDataRequest implements ISaveSensorDataRequest {

        /**
         * Constructs a new SaveSensorDataRequest.
         * @param [properties] Properties to set
         */
        constructor(properties?: Logs.ISaveSensorDataRequest);
        ...
        /** SaveSensorDataRequest logs. */
        public logs?: (Logs.ILogs|null);

        /**
         * Creates a new SaveSensorDataRequest instance using the specified properties.
         * @param [properties] Properties to set
         * @returns SaveSensorDataRequest instance
         */
        public static create(properties?: Logs.ISaveSensorDataRequest): Logs.SaveSensorDataRequest;
         ...
         * @param message SaveSensorDataRequest message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: Logs.ISaveSensorDataRequest, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: Logs.ISaveSensorDataRequest, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a SaveSensorDataRequest message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns SaveSensorDataRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): Logs.SaveSensorDataRequest;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): Logs.SaveSensorDataRequest;
         ...
         * @returns SaveSensorDataRequest
         */
        public static fromObject(object: { [k: string]: any }): Logs.SaveSensorDataRequest;

        /**
         * Creates a plain object from a SaveSensorDataRequest message. Also converts values to other types if specified.
         * @param message SaveSensorDataRequest
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: Logs.SaveSensorDataRequest, options?: $protobuf.IConversionOptions): { [k: string]: any };
