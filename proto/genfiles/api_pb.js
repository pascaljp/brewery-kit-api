...
$root.Logs = (function() {
    ...
    Logs.SaveSensorDataRequest = (function() {

        /**
         * Properties of a SaveSensorDataRequest.
         * @memberof Logs
         * @interface ISaveSensorDataRequest
         * @property {boolean|null} [backfill] SaveSensorDataRequest backfill
         * @property {string|null} [machineId] SaveSensorDataRequest machineId
         * @property {Logs.ILogs|null} [logs] SaveSensorDataRequest logs
         */

        /**
         * Constructs a new SaveSensorDataRequest.
         * @memberof Logs
         * @classdesc Represents a SaveSensorDataRequest.
         * @implements ISaveSensorDataRequest
         * @constructor
         * @param {Logs.ISaveSensorDataRequest=} [properties] Properties to set
         */
        function SaveSensorDataRequest(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * SaveSensorDataRequest backfill.
         * @member {boolean} backfill
         * @memberof Logs.SaveSensorDataRequest
         * @instance
         */
        SaveSensorDataRequest.prototype.backfill = false;

        /**
         * SaveSensorDataRequest machineId.
         * @member {string} machineId
         * @memberof Logs.SaveSensorDataRequest
         * @instance
         */
        SaveSensorDataRequest.prototype.machineId = "";

        /**
         * SaveSensorDataRequest logs.
         * @member {Logs.ILogs|null|undefined} logs
         * @memberof Logs.SaveSensorDataRequest
         * @instance
         */
        SaveSensorDataRequest.prototype.logs = null;

        /**
         * Creates a new SaveSensorDataRequest instance using the specified properties.
         * @function create
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Logs.ISaveSensorDataRequest=} [properties] Properties to set
         * @returns {Logs.SaveSensorDataRequest} SaveSensorDataRequest instance
         */
        SaveSensorDataRequest.create = function create(properties) {
            return new SaveSensorDataRequest(properties);
        };

        /**
         * Encodes the specified SaveSensorDataRequest message. Does not implicitly {@link Logs.SaveSensorDataRequest.verify|verify} messages.
         * @function encode
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Logs.ISaveSensorDataRequest} message SaveSensorDataRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SaveSensorDataRequest.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.backfill != null && Object.hasOwnProperty.call(message, "backfill"))
                writer.uint32(/* id 1, wireType 0 =*/8).bool(message.backfill);
            ...
            if (message.logs != null && Object.hasOwnProperty.call(message, "logs"))
                $root.Logs.Logs.encode(message.logs, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified SaveSensorDataRequest message, length delimited. Does not implicitly {@link Logs.SaveSensorDataRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Logs.ISaveSensorDataRequest} message SaveSensorDataRequest message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SaveSensorDataRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SaveSensorDataRequest message from the specified reader or buffer.
         * @function decode
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {Logs.SaveSensorDataRequest} SaveSensorDataRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SaveSensorDataRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Logs.SaveSensorDataRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 3: {
                        message.logs = $root.Logs.Logs.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a SaveSensorDataRequest message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SaveSensorDataRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SaveSensorDataRequest message.
         * @function verify
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SaveSensorDataRequest.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.backfill != null && message.hasOwnProperty("backfill"))
                if (typeof message.backfill !== "boolean")
                    return "backfill: boolean expected";
            ...
            if (message.logs != null && message.hasOwnProperty("logs")) {
                var error = $root.Logs.Logs.verify(message.logs);
                if (error)
                    return "logs." + error;
            }
            return null;
        ...
        /**
         * Creates a SaveSensorDataRequest message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {Logs.SaveSensorDataRequest} SaveSensorDataRequest
         */
        SaveSensorDataRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.Logs.SaveSensorDataRequest)
                return object;
            var message = new $root.Logs.SaveSensorDataRequest();
            if (object.backfill != null)
                message.backfill = Boolean(object.backfill);
            if (object.machineId != null)
                message.machineId = String(object.machineId);
            if (object.logs != null) {
                if (typeof object.logs !== "object")
                    throw TypeError(".Logs.SaveSensorDataRequest.logs: object expected");
                message.logs = $root.Logs.Logs.fromObject(object.logs);
            }
            return message;
        };

        /**
         * Creates a plain object from a SaveSensorDataRequest message. Also converts values to other types if specified.
         * @function toObject
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {Logs.SaveSensorDataRequest} message SaveSensorDataRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SaveSensorDataRequest.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.backfill = false;
                object.machineId = "";
                object.logs = null;
            }
            if (message.backfill != null && message.hasOwnProperty("backfill"))
                object.backfill = message.backfill;
            if (message.machineId != null && message.hasOwnProperty("machineId"))
                object.machineId = message.machineId;
            if (message.logs != null && message.hasOwnProperty("logs"))
                object.logs = $root.Logs.Logs.toObject(message.logs, options);
            return object;
        };

        /**
         * Converts this SaveSensorDataRequest to JSON.
         * @function toJSON
         * @memberof Logs.SaveSensorDataRequest
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SaveSensorDataRequest.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for SaveSensorDataRequest
         * @function getTypeUrl
         * @memberof Logs.SaveSensorDataRequest
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        SaveSensorDataRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/Logs.SaveSensorDataRequest";
        };

        return SaveSensorDataRequest;
    })();
